                                    ...
                                    child: Form(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const Text(
                                            "We're sad to see tou go. So you're aware, deleting your account will permanently remove your account and all progress. You cannot undo this action.\n\nEnter the word Confirm to perform this action.",
                                            style: TextStyle(
                                              fontFamily: 'Poppins',
                                              fontWeight: FontWeight.w400,
                                              fontSize: 13,
                                                  ...
                                                  : () async {
                                                      ...
                                                      try {
                                                        await UserService.deleteAccount(
                                                          currentPassword: confirmController.text,
                                                        );
                                                        if (context.mounted) {
                                                          Navigator.of(context).pop();
                                                          final prefs = await SharedPreferences.getInstance();
